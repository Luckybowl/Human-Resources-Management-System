...
public class GetEmployeeByDept extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		//2.
		EmployeeService deptss=new EmployeeServiceImpl();
		List<Employee> depts =deptss.getEmployeeByDept( dept_no);
		request.setAttribute("employee", depts);
		
		//3.
		request.getRequestDispatcher("../dept/empl.jsp").forward(request, response);
		out.flush();
		out.close();
	}
