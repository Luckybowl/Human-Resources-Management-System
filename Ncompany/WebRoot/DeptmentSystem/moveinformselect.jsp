...
<html>
  <head>
    ...
    <title>My JSP 'moveinformselect.jsp' starting page</title>
...
<link rel="stylesheet" type="text/css" href="date/calendar-win2k-cold-1.css">
  ...
  <body>
  <form action="<%=basePath %>servlet/deptadjustselect"  method="post" name="frm1">
   <br>
<br>
...
<option value="diaodu">升职</option><option value="diaodu">降职</option></select></center>
<br />
<br />
